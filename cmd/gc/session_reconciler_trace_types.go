...
const (
	...
	TraceSiteReconcilerHandoffRestartNoEffect TraceSiteCode = "reconciler.session.handoff_restart_no_effect"
...
const (
	...
	TraceReasonHandoffRestartNoEffect TraceReasonCode = "handoff_restart_no_effect"
