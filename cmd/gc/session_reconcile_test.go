...
func newTestStore() *testStore {
	return &testStore{metadata: make(map[string]map[string]string), local: make(map[string]map[string]string)}
}
...
// of the embedded beads.Store's nil-interface promotion, which panics.
