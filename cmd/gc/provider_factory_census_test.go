...
var canonicalProviderCalls = map[string]int{
	...
	"cmd_nudge.go:deliverSessionNudgeWithIngress:newSessionProvider:bind-error":                                                                1,
	...
	"cmd_stop.go:cmdStopBodyWithHeldOwnership:sessionProviderForStopCity:bind-error":                                                           1,
	"cmd_supervisor.go:startManagedCity:newSessionProviderFromContext:bind-error":                                                              1,
