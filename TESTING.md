...
| --- | --- | --- | --- | --- | --- | --- |
| Audit baseline | all tracked test source | fixed_sleep: 422 calls / 157 files (historical regex census: 447 / 157) | ga-80po0c.2 | tracked test source totals remain visible as audit evidence; ga-80po0c.2 owns this point-in-time source census | P0.4a | 2026-10-01 |
...
| Audit baseline | all tracked test source | subprocess: 543 calls / 164 files (historical regex census: 495 / 135) | ga-80po0c.2 | tracked test source totals remain visible as audit evidence; ga-80po0c.2 owns this point-in-time source census | P0.4a | 2026-10-01 |
...
| Medium owner | `internal/session` package `session` | TestCreateSessionAllowsWorkDirWhenLiveProcessIsUnattributedSquatter: subprocess, fixed_sleep | ga-esrrot | cwd-collision session-owned-PID scoping regression (ga-thkwp5 Failure 2) is a checked Medium owner; the one real sleep(1) subprocess and its time.Sleep poll are confined to TestCreateSessionAllowsWorkDirWhenLiveProcessIsUnattributedSquatter, which proves liveness scoping against genuine /proc data instead of a fake scanner | ga-thkwp5 | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | fixed_sleep: 276 calls / 110 files (historical regex census: 295 / 114) | ga-80po0c.2 | untagged fixed-sleep call/file totals cannot grow; reductions must lower this baseline; each owning test replaces elapsed wall time with its lifecycle signal | W1-W5 | 2026-10-01 |
...
| Source debt ratchet | all untagged test source | subprocess: 404 calls / 113 files (historical regex census: 380 / 98) | ga-80po0c.2 | untagged subprocess call/file totals cannot grow; reductions must lower this baseline; each process-owning test removes or replaces its source call site | D1/D2/D5/D6/E6 | 2026-10-01 |
