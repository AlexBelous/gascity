 ...
 */
export const postV0CityByCityNameBeadByIdClaim = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameBeadByIdClaimData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameBeadByIdClaimResponses, PostV0CityByCityNameBeadByIdClaimErrors, ThrowOnError>({
