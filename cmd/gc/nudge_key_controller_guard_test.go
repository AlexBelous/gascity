...
func TestNudgeKeySchedulingTelemetryRecorderIsTheSoleCapabilityBoundary(t *testing.T) {
	...
	assertASTCallsOnly(t, fset, recorder, "nudge scheduling telemetry recorder", map[string]bool{
		...
		"errors.New":                                      true,
		"nudgeKeyBacklogInstrumentState.mu.Lock":          true,
		"loadNudgeKeyBacklogInstrumentsLocked":            true,
		"nudgeKeyBacklogInstrumentState.mu.Unlock":        true,
		"uint64":                           true,
		"make":                             true,
		"once.Do":                          true,
		"delete":                           true,
		"meter.Int64ObservableGauge":       true,
		"meter.Float64ObservableGauge":     true,
		"meter.RegisterCallback":           true,
		"aggregateNudgeKeyBacklog":         true,
		"observer.ObserveInt64":            true,
		"observer.ObserveFloat64":          true,
		"nudgeKeyBacklogAgeStateLabel":     true,
		"len":                              true,
		"append":                           true,
		"slices.Sort":                      true,
		"invokeNudgeKeyBacklogObserver":    true,
		"validateNudgeKeyBacklogRecord":    true,
		"<func>":                           true,
		"recover":                          true,
		"observer":                         true,
		"snapshot.registration.Unregister": true,
	})
