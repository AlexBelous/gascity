...
/**
 * Delete v0 city by city name formulas by name
 */
export const deleteV0CityByCityNameFormulasByName = <ThrowOnError extends boolean = false>(options: Options<DeleteV0CityByCityNameFormulasByNameData, ThrowOnError>) => (options.client ?? client).delete<DeleteV0CityByCityNameFormulasByNameResponses, DeleteV0CityByCityNameFormulasByNameErrors, ThrowOnError>({ url: '/v0/city/{cityName}/formulas/{name}', ...options });
...
/**
 * Put v0 city by city name formulas by name
 */
export const putV0CityByCityNameFormulasByName = <ThrowOnError extends boolean = false>(options: Options<PutV0CityByCityNameFormulasByNameData, ThrowOnError>) => (options.client ?? client).put<PutV0CityByCityNameFormulasByNameResponses, PutV0CityByCityNameFormulasByNameErrors, ThrowOnError>({
    bodySerializer: null,
 ...
 */
export const triggerMaintenanceDoltGc = <ThrowOnError extends boolean = false>(options: Options<TriggerMaintenanceDoltGcData, ThrowOnError>) => (options.client ?? client).post<TriggerMaintenanceDoltGcResponses, TriggerMaintenanceDoltGcErrors, ThrowOnError>({ url: '/v0/city/{cityName}/maintenance/dolt-gc', ...options });
...
/**
 * Post v0 city by city name order by name run
 */
export const postV0CityByCityNameOrderByNameRun = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameOrderByNameRunData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameOrderByNameRunResponses, PostV0CityByCityNameOrderByNameRunErrors, ThrowOnError>({
 ...
 * Add a pack
 *
 * Imports a pack into the city by source (a remote git URL or registry ref), resolving + installing it so its templates compose into the city.
 */
export const addPack = <ThrowOnError extends boolean = false>(options: Options<AddPackData, ThrowOnError>) => (options.client ?? client).post<AddPackResponses, AddPackErrors, ThrowOnError>({
...
/**
 * Delete v0 city by city name packs by name
 */
export const deleteV0CityByCityNamePacksByName = <ThrowOnError extends boolean = false>(options: Options<DeleteV0CityByCityNamePacksByNameData, ThrowOnError>) => (options.client ?? client).delete<DeleteV0CityByCityNamePacksByNameResponses, DeleteV0CityByCityNamePacksByNameErrors, ThrowOnError>({ url: '/v0/city/{cityName}/packs/{name}', ...options });
 ...
 */
export const getV0CityByCityNamePending = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNamePendingData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNamePendingResponses, GetV0CityByCityNamePendingErrors, ThrowOnError>({ url: '/v0/city/{cityName}/pending', ...options });
...
/**
 * Get v0 city by city name runs
 */
export const getV0CityByCityNameRuns = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameRunsData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameRunsResponses, GetV0CityByCityNameRunsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/runs', ...options });

/**
 * Get v0 city by city name runs census
 */
export const getV0CityByCityNameRunsCensus = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameRunsCensusData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameRunsCensusResponses, GetV0CityByCityNameRunsCensusErrors, ThrowOnError>({ url: '/v0/city/{cityName}/runs/census', ...options });

/**
 * Get v0 city by city name runs by run ID
 */
export const getV0CityByCityNameRunsByRunId = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameRunsByRunIdData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameRunsByRunIdResponses, GetV0CityByCityNameRunsByRunIdErrors, ThrowOnError>({ url: '/v0/city/{cityName}/runs/{run_id}', ...options });

/**
 * Post v0 city by city name runs by run ID cancel
 */
export const postV0CityByCityNameRunsByRunIdCancel = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameRunsByRunIdCancelData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameRunsByRunIdCancelResponses, PostV0CityByCityNameRunsByRunIdCancelErrors, ThrowOnError>({ url: '/v0/city/{cityName}/runs/{run_id}/cancel', ...options });

/**
 * Get v0 city by city name runs by run ID detail
 */
export const getV0CityByCityNameRunsByRunIdDetail = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameRunsByRunIdDetailData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameRunsByRunIdDetailResponses, GetV0CityByCityNameRunsByRunIdDetailErrors, ThrowOnError>({ url: '/v0/city/{cityName}/runs/{run_id}/detail', ...options });

/**
 * Get v0 city by city name runs by run ID steps
 */
export const getV0CityByCityNameRunsByRunIdSteps = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameRunsByRunIdStepsData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameRunsByRunIdStepsResponses, GetV0CityByCityNameRunsByRunIdStepsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/runs/{run_id}/steps', ...options });
...
/**
 * Get v0 city by city name usage
 */
export const getV0CityByCityNameUsage = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameUsageData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameUsageResponses, GetV0CityByCityNameUsageErrors, ThrowOnError>({ url: '/v0/city/{cityName}/usage', ...options });

/**
 * Get v0 city by city name wait by ID
 */
export const getV0CityByCityNameWaitById = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameWaitByIdData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameWaitByIdResponses, GetV0CityByCityNameWaitByIdErrors, ThrowOnError>({ url: '/v0/city/{cityName}/wait/{id}', ...options });

/**
 * Get v0 city by city name waits
 */
export const getV0CityByCityNameWaits = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameWaitsData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameWaitsResponses, GetV0CityByCityNameWaitsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/waits', ...options });
